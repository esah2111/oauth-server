...
INSERT INTO oauth_client_details (client_id, client_secret, scope, authorized_grant_types, authorities, access_token_validity, autoapprove, web_server_redirect_uri)
  VALUES ('clientId', '{bcrypt}$2a$10$vCXMWCn7fDZWOcLnIEhmK.74dvK1Eh8ae2WrWlhr2ETPLoxQctN4.', 'read,write', 'authorization_code,password,refresh_token,client_credentials', 'ROLE_CLIENT', 300, 'true', 'http://localhost:8080');
